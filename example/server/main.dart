...
Future<void> main(List<String>? args) async {
  ...
  CliArguments cliArguments = CliArguments(cliArgs).addCustomMultiOption(
    'newValues',
    help:
        'Demo to customize args, will add new values. e.g. --newValues Foo --newValues Bar',
  );
